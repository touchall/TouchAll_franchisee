package allpointech.franchisee.franchisee.history;
...
import allpointech.franchisee.franchisee.info.FranchiseeInfo1Activity;
...
public class FranchiseeHistoryFragment extends BaseFragment implements BaseAppCompatActivity.onKeyBackPressedListener, TNHttpMultiPartTask.onHttpNetResultListener, View.OnClickListener {
    public static final String FRAGMENT_TAG = FranchiseeHistoryFragment.class.getSimpleName();
    ...
    protected int inflateLayout() {
        return R.layout.fragment_franchisee_history;
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_franchisee_info_next:
                startActivityForResult(new Intent(getActivity(), FranchiseeInfo1Activity.class), 12123);
                break;
