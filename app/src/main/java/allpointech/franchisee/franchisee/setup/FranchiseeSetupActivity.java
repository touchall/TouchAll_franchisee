...
public class FranchiseeSetupActivity extends BaseAppCompatActivity implements NfcAdapter.OnNdefPushCompleteCallback {

    private FranchiseeSetupActivity.OnNfcCompleteListener mListener;

    public void setOnNfcCompleteListener(FranchiseeSetupActivity.OnNfcCompleteListener listener) {
        mListener = listener;
    }
