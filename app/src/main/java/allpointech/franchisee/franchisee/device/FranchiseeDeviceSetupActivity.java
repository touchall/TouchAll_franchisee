...
import allpointech.franchisee.franchisee.setup.FranchiseeSetupFragment;
...
public class FranchiseeDeviceSetupActivity extends BaseAppCompatActivity implements NfcAdapter.OnNdefPushCompleteCallback {

    private FranchiseeDeviceSetupActivity.OnNfcCompleteListener mListener;

    public void setOnNfcCompleteListener(FranchiseeDeviceSetupActivity.OnNfcCompleteListener listener) {
        mListener = listener;
    }
    ...
    */
    ...
    protected BaseFragment initFragment() {
        ...
        FranchiseeDeviceSetupFragment fragment = new FranchiseeDeviceSetupFragment();
        if (getIntent() != null) {
