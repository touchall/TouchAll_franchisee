...
public class FranchiseeInfoFragment extends BaseFragment implements BaseAppCompatActivity.onKeyBackPressedListener, TNHttpMultiPartTask.onHttpNetResultListener, View.OnClickListener {
    public static final String FRAGMENT_TAG = FranchiseeInfoFragment.class.getSimpleName();
...
//    }
    ...
    protected int inflateLayout() {
        return R.layout.fragment_franchisee_info;
    }
