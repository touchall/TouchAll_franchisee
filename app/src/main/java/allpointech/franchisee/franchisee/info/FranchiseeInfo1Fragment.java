...
public class FranchiseeInfo1Fragment extends BaseFragment implements BaseAppCompatActivity.onKeyBackPressedListener, TNHttpMultiPartTask.onHttpNetResultListener, View.OnClickListener {
    public static final String FRAGMENT_TAG = FranchiseeInfo1Fragment.class.getSimpleName();
    ...
    protected int inflateLayout() {
        return R.layout.fragment_franchisee_info1;
    }
    ...
    protected void initLayout(View view) {
        ...
        mBtnNext = (Button)view.findViewById(R.id.btn_franchisee_setup_next);
        mBtnNext.setOnClickListener(this);
        mBtnModify = (Button)view.findViewById(R.id.btn_franchisee_setup_modify);
...
////        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_franchisee_setup_next:
                startActivityForResult(new Intent(getActivity(), FranchiseeInfo2Activity.class), 12123);
                break;
            case R.id.btn_franchisee_setup_modify:
                startActivityForResult(new Intent(getActivity(), FranchiseeSetupActivity.class), 12124);
                break;
        }
