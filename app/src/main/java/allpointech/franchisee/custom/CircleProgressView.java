...
public class CircleProgressView extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        setShowUnit(a.getBoolean(R.styleable.CircleProgressView_showValue, mShowValue));
    ...
    public static float spToDip(Context context, float value) {
    ...
    private void drawCircleWithNumber(Canvas canvas, float _degrees) {
        ...
        if (mShowUnit) {
            ...
            canvas.drawText(mUnit, mUnitBounds.left, mUnitBounds.bottom + spToDip(getContext(), 20.0f), mUnitTextPaint);
        }
    }
