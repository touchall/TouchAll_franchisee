...
public class ResPositionAgree extends ResBaseHttp {
    ...
    public String makeURL() throws Exception {
        return "https://dev.touchall.co.kr/clause/locationContent";
    ...
    public class KEY_RES {
        public static final String position_agree = "position_agree";
    }
